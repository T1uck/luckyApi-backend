package com.luckyone.luckyclientsdk.client;
...
import static com.luckyone.luckyclientsdk.utils.SignUtils.genSign;

/**
 * API 调用
 */
public class LuckyApiClient {
    ...
    public LuckyApiClient(String accessKey, String secretKey) {
