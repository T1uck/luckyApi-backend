package com.luckyone.luckyapiadmin.controller;

import cn.hutool.json.JSONUtil;
import com.luckyone.luckyapiadmin.annotation.AuthCheck;
import com.luckyone.luckyapiadmin.config.GatewayConfig;
import com.luckyone.luckyapiadmin.exception.BusinessException;
import com.luckyone.luckyapiadmin.exception.ThrowUtils;
import com.luckyone.luckyapiadmin.service.InterfaceInfoService;
import com.luckyone.luckyapiadmin.service.UserService;
import com.luckyone.luckyapicommon.common.*;
import com.luckyone.luckyapicommon.constant.CommonConstant;
import com.luckyone.luckyapicommon.constant.UserConstant;
import com.luckyone.luckyapicommon.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.luckyone.luckyapicommon.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import com.luckyone.luckyapicommon.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.luckyone.luckyapicommon.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
import com.luckyone.luckyapicommon.model.entity.InterfaceInfo;
import com.luckyone.luckyapicommon.model.entity.User;
import com.luckyone.luckyapicommon.model.enums.InterfaceInfoStatusEnum;
import com.luckyone.luckyapicommon.model.vo.InterfaceInfoVO;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        // 获取SDK客户端
        LuckyApiClient luckyApiClient = interfaceInfoService.getluckyApiClient(request);
        // 设置网关地址
        luckyApiClient.setGatewayHost(gatewayConfig.getHost());
        try {
            // 执行方法
            String invokeResult = luckyApiClient.invokeInterface(requestParams, url, method);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        try {
            // 执行方法
            invokeResult = luckyApiClient.invokeInterface(requestParams, url, method);
            if (StringUtils.isBlank(invokeResult)) {
                throw new BusinessException(ErrorCode.SYSTEM_ERROR, "接口数据为空");
            }
        } catch (Exception e) {
